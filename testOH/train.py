...
if __name__ == '__main__': 
    ...
    data_loader = BuildDataLoader(num_labels=config['MODEL']['num_labels'], dataset_path=config['DIRECTORY']['dataset'],
                                  batch_size=config['DATALOADER']['batch_size'], split_rate=config['MODEL']['split_rate'])
    ...
    # num_of_model_param = sum(p.numel() for p in model.parameters())
    # print(num_of_model_param)
